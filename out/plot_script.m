...
xlim([-2 16])
ylim([-4 0])
title('Comparação entre todos os códigos desenvolvidos')
...
legend('Não codificado', 'Código de Hamming', 'Cíclico 9x15', 'Código próprio 15x35' ...
, 'Comparação Hamming polinômio 1', 'Comparação Exata polinômio 1', ...
'Comparação Euclidiana polinômio 1');